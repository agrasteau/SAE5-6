...
const resetFilters = () => {
    ...
    (document.body.classList.contains('-augementationphysique')) ||
    ...
    render()
    {
        return (
            <div className='mix-tab_filters'>
                ...
                <label><input type="checkbox" id="filtrePhisicalAugement" value="augementation physique"></input>{t('common.augmentationfromphysical')}</label>
