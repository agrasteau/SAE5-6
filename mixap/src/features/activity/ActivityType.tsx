...
import augmentationFromPhysical from '../../assets/augmentationFromPhysical.png';
import { default as Group, default as SmartGroup } from '../../assets/ensemble.png';
...
export enum ActivityType {
  ...
  augmentationFromPhysical = 'augmentationFromPhysical'
}
...
export const activityTypeList = {
  ...
  [ActivityType.augmentationFromPhysical]: {
    title: 'common.augmentationfromphysical-title',
    description: 'common.augmentationfromphysical-description',
    cover: augmentationFromPhysical,
    type: ActivityType.augmentationFromPhysical,
    placeholders: {
      title: 'common.augmentationfromphysical-placeholder-title',
      instruction: 'common.augmentationfromphysical-placeholder-instruction',
      description: 'common.augmentationfromphysical-placeholder-description',
    },
    disabled: false,
  },
