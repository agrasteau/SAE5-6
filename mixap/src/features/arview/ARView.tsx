        ...
        if (data.type === 'updateMatrix') {
          ...
          anchors.forEach(
            ({ anchor, target, onAnchorFound, onAnchorLost }: any) => {
              //log( 'tracking check onupdate strictMode, imageTargets', strictMode, imageTargets, controller.__isCamTrack, anchor.visible,);
              if (!strictMode) {
              ...
              if (target === targetIndex) {
                ...
                if (!allFound && !timer) {
                  ...
                  timer = setTimeout(() => {
                   ...
                   // log('timer set check found?', allFound, maxTrackIndices, targetIndices,);
                ...
                if (!targetIndices.has(targetIndex) && worldMatrix !== null) {
                  ...
                  //log('timer set check anchor found add it', targetIndex, targetIndices,);
                } else if (
                  ...
                  //log( 'timer set check anchor lost delete it', targetIndex, targetIndices,);
                }
...
export { ARAnchor, ARFaceMesh, ARView };
