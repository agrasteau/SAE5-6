...
export function Board({ activity }: { activity: Partial<ActivityDocType> }) {
  ...
  // if (!steps[current]) {
  //   console.error('Current step is undefined. Please check the steps array.'); // Log a descriptive error message
  //   return null; // Optionally return null or any other fallback UI component
  // }
  const {
    useCanvas = true,
