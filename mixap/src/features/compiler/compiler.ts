...
import { Compiler as CompilerBase } from 'mind-ar/src/image-target/compiler';
import { Detector } from 'mind-ar/src/image-target/detector/detector';
import {
  buildImageList,
...
import CompilerWorker from './arcompiler.worker.js?worker&inline';
