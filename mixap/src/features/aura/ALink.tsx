import { DeleteOutlined, LinkOutlined } from '@ant-design/icons'; // Icons from Ant Design
import { a as a3f, useSpring } from '@react-spring/three'; // Spring animations for Three.js objects
...
import { Popover, Typography } from 'antd'; // Ant Design components for typography and popovers
