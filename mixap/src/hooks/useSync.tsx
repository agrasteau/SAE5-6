import { Space, Spin, Typography, notification } from 'antd';
...
import { ActivityDocType, AuraDocType, RxColOp } from '../db/types';
      ...
      try {
        ...
        auraDocs = await Promise.all(
          auraDocs.map(async (auraDoc, index) => {
            ...
            if (['AImage', 'AVideo', 'AAudio', 'A3d', 'AAugemented',].includes(doc.type)) {
